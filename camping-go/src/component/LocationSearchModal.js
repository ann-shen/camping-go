  ...
  render() {
    ...
    return (
      <div style={{ padding: "1rem", margin: "0 auto", maxWidth: 1000 }}>
        ...
        <div label='City'>{this.state.city}</div>
        <div label='Area'>{this.state.area}</div>
        <div label='State'>{this.state.state}</div>
        <div label='Address'>{this.state.address}</div>

        <AsyncMap
          googleMapURL='https://maps.googleapis.com/maps/api/js?key=AIzaSyDGyok70ayGPpyAyxeyAwcVdoQ0rzW5bCo&libraries=places'
          loadingElement={<div style={{ height: `100%` }} />}
