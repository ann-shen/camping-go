...
function Taiwan() {
  ...
  useEffect(() => {
    ...
    let north = ["台北市", "新北市", "桃園市"];
    let northeast = ["宜蘭縣", "南投縣", "基隆市"];
    let east = ["花蓮縣", "台東縣", "屏東縣"];
    let south = ["雲林縣", "嘉義縣", "嘉義市", "台南市", "高雄市"];

    if (middle.includes(targetCity)) {
      setPosition("middle");
    } else if (north.includes(targetCity)) {
      setPosition("north");
    } else if (northeast.includes(targetCity)) {
      setPosition("northEast");
    } else if (east.includes(targetCity)) {
      setPosition("east");
    } else if (south.includes(targetCity)) {
      setPosition("south");
    } else {
      setPosition("");
    }
    ...
    <Releate>
      ...
      <svg
        ...
        <path
          ...
          data-name='path
            2462'
          className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan '
        ...
        />
        <Link to={"target/chiayi_country"}>
          <path
            onMouseEnter={handleMove}
            id='2b6aac2d-ce2d-4c48-89d5-ff2a81000e07'
            data-name='chiayi_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan chiayi_country'
        ...
        />
        <Link to={"target/taichung_city"}>
          <path
            onMouseEnter={handleMove}
            id='30e45b59-571b-4340-a006-0ba62460619a'
            data-name='taichung_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan taichung_city'
        ...
        <Link to={"target/keelung_city"}>
          <path
            onMouseEnter={handleMove}
            id='21535635-db1e-4831-a63f-263ab3ed4b79'
            data-name='keelung_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan keelung_city'
        ...
        <Link to={"target/pingtung_country"}>
          <path
            onMouseEnter={handleMove}
            id='21c4ba33-d057-42c1-9c71-be6061fc73cf'
            data-name='pingtung_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan pingtung_country'
        ...
        <Link to={"target/taipei_city"}>
          <path
            onMouseEnter={handleMove}
            id='1e48e0bb-8964-4121-b347-b900162cf771'
            data-name='taipei_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan taipei_city'
        ...
        <Link to={"target/new_taipei_city"}>
          <path
            onMouseEnter={handleMove}
            id='66958373-17e2-4fab-8b83-b16e2d323782'
            data-name='new_taipei_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan new_taipei_city'
        ...
        <Link to={"target/yilan_country"}>
          <path
            onMouseEnter={handleMove}
            id='f8107e5f-0c12-4631-aed9-d525f4e8558d'
            data-name='yilan_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan yilan_country'
        ...
        <Link to={"target/taoyuan_country"}>
          <path
            onMouseEnter={handleMove}
            id='65175d47-0a21-4bf1-abfb-b58e4d3069a0'
            data-name='taoyuan_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan taoyuan_country'
        ...
        <Link to={"target/hsinchu_city"}>
          <path
            onMouseEnter={handleMove}
            id='350fa9bc-d25e-4c61-ae4b-b5c60b1a74b6'
            data-name='hsinchu_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan hsinchu_city'
        ...
        <Link to={"target/hsinchu_country"}>
          <path
            onMouseEnter={handleMove}
            id='ea41be52-3728-49f2-aa36-b90633ee55f6'
            data-name='hsinchu_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan hsinchu_country'
        ...
        <Link to={"target/miaoli_country"}>
          <path
            onMouseEnter={handleMove}
            id='ffd01e75-6ce2-4cfa-af98-bc61479c68ed'
            data-name='miaoli_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan miaoli_country'
        ...
        <Link to={"target/changhua_country"}>
          <path
            onMouseEnter={handleMove}
            id='d5701392-fc06-4411-bf79-2703f225ab2e'
            data-name='changhua_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan changhua_country'
        ...
        <Link to={"target/yunlin_country"}>
          <path
            onMouseEnter={handleMove}
            id='4eed8214-870d-46ff-b77b-49234479d430'
            data-name='yunlin_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan yunlin_country'
        ...
        <Link to={"target/hualien_country"}>
          <path
            onMouseEnter={handleMove}
            id='e468a7aa-2bdf-4501-b48d-35483b7c8ccc'
            data-name='hualien_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan hualien_country'
        ...
        <Link to={"target/nantou_country"}>
          <path
            onMouseEnter={handleMove}
            id='7ed22330-8901-4fc6-a351-206f6b2daf2b'
            data-name='nantou_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan nantou_country'
        ...
        <Link to={"target/taitung_country"}>
          <path
            onMouseEnter={handleMove}
            id='ae9239f1-7686-4c40-a5f8-f322391c7328'
            data-name='taitung_country'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan taitung_country'
        ...
        <Link to={"target/tainan_city"}>
          <path
            onMouseEnter={handleMove}
            id='0ce2847a-4f9c-4ff7-8c51-6b0fa24ba8b7'
            data-name='tainan_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan tainan_city'
        ...
        <Link to={"target/kaohsiung_city"}>
          <path
            onMouseEnter={handleMove}
            id='e1806d87-d003-48dd-b8d3-3f99b3759340'
            data-name='kaohsiung_city'
            className='96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 taiwan kaohsiung_city'
